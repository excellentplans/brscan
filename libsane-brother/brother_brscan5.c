 ...
 * by the golden tests; brscan5_start() uses the *_dyn() builders.
 * ====================================================================== */
                    ...
                    int brit, int cont, const char *area)
{
     ...
     * experiment (BROTHER5_HWTEST_COMP_NONE) — device support unknown. */
    const char *comp = "JPEG";
    const char *tone = "ON";
    if (color_type == COLOR_BW) {
        comp = getenv("BROTHER5_HWTEST_COMP_NONE") ? "NONE" : "RLENGTH";
        tone = "OFF";
    }
